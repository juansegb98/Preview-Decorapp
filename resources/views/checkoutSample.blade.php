...
<div class="container bg-light">
    ...
    <div class="border rounded bg-white p-4 mb-4">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="storage/frames/{{$frame->frame_src_preview}}" width="100%" alt="">
        ...
        <div class="row">
            <div class="col-12">
                <p class="ml-auto" align="right" style="font-size:xx-large" class>Total: ${{$priceSampleFrames}}</p>
            </div>
        </div>
        <h3>Shipping Address</h3>
        <form action="{{ url('mail_sample_frames') }}" method="POST">
        <div class="form-row">
        ...
        <div class="hidden-input">
            <input type="text" id="framesList" name="framesList" value="{{$framesList}}">
            <input type="text" id="priceSampleFrames" name="priceSampleFrames" value="{{$priceSampleFrames}}" >
        </div>
    </div>
        <div class="row">
            <button class="btn ml-auto mb-4 col-md-5 btn-dark">Confirm</button>
        </div>
        </form>
    </div>
